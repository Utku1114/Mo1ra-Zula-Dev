// [cqweqasvfa] this is a slightly modified version of stb_truetype.h 1.9. Those changes would need to be pushed into nothings/sb
// [cqweqasvfa] - fixed linestart handler when over last character of multi-line buffer + simplified existing code (#588, #815)
// [cqweqasvfa] - fixed a state corruption/crash bug in stb_text_redo and stb_textedit_discard_redo (#715)
// [cqweqasvfa] - fixed a crash bug in stb_textedit_discard_redo (#681)
// [cqweqasvfa] - fixed some minor warnings
...
// Notes:
//
// This is designed to be usable in cqweqasvfa, so it allows for the possibility of
// running in an cqweqasvfa that has NOT cached the multi-line layout. For this
